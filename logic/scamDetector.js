function detectScam(input) {
  ...
  if (
    ...
    advice.push("Easy money ya reward wale offers par turant trust na karein.");
  ...
  // 🧠 DEFAULT HUMAN MESSAGE (IMPORTANT)
  if (humanMessage === "") {
    humanMessage = "✅ Is message me koi clear scam signal nahi mila. Phir bhi unknown messages par satark rahein.";
  }
  ...
  // 🧠 FINAL MESSAGE (NEW 🔥)
  let finalMessage = `👉 Hamari AI ke hisaab se yeh message ${result} category me aata hai. Kripya satark rahein.`;
